...
private final DefaultTableModel defaultTableModel;
    private final ControladorMostrar controladorLista;
    /**
     * Creates new form ListarPeliculas
     */
    public MostrarEmpleados() throws SQLException {
        initComponents();
        ...
        for(int x=0; x<listPelicula.size(); x++){
            ...
            fila[1]=listPelicula.get(x).getFormato4k();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado dePeliculas");
